...
from durator.world.game.character.constants import CharacterClass, CharacterRace
from durator.world.game.object.type.unit import DEFAULT_SPEEDS, UnitPower
...
RACE_AND_CLASS_DEFAULTS = {(CharacterRace.UNDEAD, CharacterClass.ROGUE): {"race": UNDEAD_DEFAULTS, "class": UNDEAD_ROGUE_DEFAULTS}}
